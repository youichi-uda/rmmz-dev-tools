...
declare namespace BattleManager {
  ...
  function updateTpbBattler(battler: Game_Actor | Game_Enemy): void;
  function checkTpbTurnEnd(): void;
  function processTurn(): void;
  function endBattlerActions(battler: Game_Actor | Game_Enemy): void;
  function endTurn(): void;
  function updateTurnEnd(): void;
  function endAllBattlersTurn(): void;
  function displayBattlerStatus(battler: Game_Actor | Game_Enemy, current: boolean): void;
